class KLearning {
  ...
  initClusters(data) {
    switch (this.init_method) {
      case "first":
        const firstCluster = require("../initClusters/klearning/first.js");
      ...
      case "random":
      default:
        const randomCluster = require("../initClusters/klearning/random.js");
  ...
  train(data, generations) {
    if (generations && data) {
      const categorize = require("../utils/klearning/categorize.js");
      const learn = require("../utils/klearning/learn.js");
